...
model.fit(health_X_train_processed, health_y_train)

# Make predictions on the test set
health_y_pred = model.predict(health_X_test_processed)

# Evaluate the model
print("Confusion Matrix:\n", confusion_matrix(health_y_test, health_y_pred))
print("Classification Report:\n", classification_report(health_y_test, health_y_pred))
